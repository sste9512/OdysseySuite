<template>
    <v-sheet>
        ...
        <a-page-header :title="filename" sub-title="TPC Image" :ghost="false"
            ...
            <div style="display: flex; flex-direction: row; gap: 16px;">
                <a-statistic title="Width" :value="tpc?.header?.width" suffix="px" />
                <a-statistic title="Height" :value="tpc?.header?.height" suffix="px" />
                <a-statistic title="Format" :value="tpc?.header?.format" />
                <a-statistic title="Mipmap Count" :value="tpc?.header?.mipMapCount" />
            </div>
        </a-page-header>
        ...
        <div ref="containerRef"
            ...
            <canvas ref="canvasRef" class="checkerboard" :style="{
