...
import * as KotOR from "../ThreeRendering/KotOR";
import UI3DRenderer from "../ThreeRendering/UI3DRenderer.vue";
import { UI3DRendererEventListenerTypes } from "../ThreeRendering/UI3DRendererTypes";
import * as THREE from 'three';

export class ModelViewerControls {

  context:InstanceType<typeof UI3DRenderer>
  ...
  constructor(context: InstanceType<typeof UI3DRenderer>){
