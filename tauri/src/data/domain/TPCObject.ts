...
import { BinaryReader } from "@/components/ThreeRendering/BinaryReader";
import { TXI } from '@/components/ThreeRendering/resource/TXI';
// @ts-ignore
import * as dxtJs from "dxt-js";
import { PixelFormat } from '@/components/ThreeRendering/enums/graphics/tpc/PixelFormat';
import { ENCODING } from '@/components/ThreeRendering/enums/graphics/tpc/Encoding';
import { OdysseyCompressedTexture } from '@/components/ThreeRendering/three/odyssey/OdysseyCompressedTexture';
import { ITPCHeader } from '@/components/ThreeRendering/interface/resource/ITPCHeader';
import { ITPCObjectOptions } from '@/components/ThreeRendering/interface/resource/ITPCObjectOptions';
